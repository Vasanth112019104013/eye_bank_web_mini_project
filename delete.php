      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 mb-5"  data-aos="fade">
            ...
            <h2 class="mb-5 text-black">Delete</h2>
     ...
     <form action="#" class="p-5 bg-white" method="post">
        ...
        <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="email" name="Email" placeholder="Enter Email id to delete" id="Email" class="form-control">
                </div>
              </div>
        <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Delete" class="btn btn-primary py-2 px-4 text-white">
                </div>
              </div>
...
{
$Email=$_POST['Email'];
$query="delete from donar where Email='$Email'";
    $query1="Select * from donar";
$result_qry=$conn->query($query);
    $result_qry1=$conn->query($query1);
...
<?php
    if(isset($result_qry1))
    {
    if($result_qry1->rowCount()>0)
    {
        $result=$result_qry1->fetchAll();
