         ...
         <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active"><a href="authourize.php">Home</a></li>
                
                <li class="has-children">
                  <a href="search.php">Search</a>
                  <ul class="dropdown">
                    <li><a href="searchtown.php">Town</a></li>
                      <li method="post" name="Bloodgroup"><a href="searchbg.php">Bloodgroup</a></li>
                  </ul>
                </li>
                <li><a href="delete.php">Delete</a></li>
                <li class="mr-5" name="View" method="post" ><a href="view.php">View</a></li>

                <li class="ml-xl-3 login"><a href="editing.php"><span class="border-left pl-xl-4"></span>Help</a></li>

                <li><a href="index.php" class="cta"><span class="bg-primary text-white rounded">Logout</span></a></li>
              </ul>
            </nav>
          </div>
