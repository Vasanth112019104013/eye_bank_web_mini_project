...
<?php
		...
		{
		$log_qry=$conn->query("select * from validation where Email='$Email' and Password='$Password'");
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar container py-0 " role="banner">
      ...
      <div class="container"> 
        ...
        <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="authourize.php" class="text-white mb-0"><br>Office Use!</a></h1>
          </div>
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/eye10.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
